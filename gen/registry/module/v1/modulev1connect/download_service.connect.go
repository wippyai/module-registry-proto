...
const (
	...
	DownloadServiceName = "registry.module.v1.DownloadService"
)
...
const (
	...
	// RPC.
	DownloadServiceDownloadProcedure = "/registry.module.v1.DownloadService/Download"
)

// DownloadServiceClient is a client for the registry.module.v1.DownloadService service.
...
// NewDownloadServiceClient constructs a client for the registry.module.v1.DownloadService service.
...
func NewDownloadServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) DownloadServiceClient {
	...
	downloadServiceMethods := v1.File_registry_module_v1_download_service_proto.Services().ByName("DownloadService").Methods()
...
// Download calls registry.module.v1.DownloadService.Download.
...
// DownloadServiceHandler is an implementation of the registry.module.v1.DownloadService service.
...
func NewDownloadServiceHandler(svc DownloadServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/registry.module.v1.DownloadService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedDownloadServiceHandler) Download(context.Context, *connect.Request[v1.DownloadRequest]) (*connect.Response[v1.DownloadResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("registry.module.v1.DownloadService.Download is not implemented"))
}
